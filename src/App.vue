<template>
  <div class="wrap">
    <DiaryHeader/>
    <DiaryInput @additem ="addMemo"/>
    <DiaryList v-bind:memodata="memoItemArr" @removeitem="deleteMemo" v-on:updateitem="updateMemo"/>
    <DiaryFooter @deleteitem="clearMemo"/>
...
<script>
  ...
  export default {
    ...
    setup(){
      ...
      // 첫화면(IntroView) 보여질 여부 설정 (true-false)
